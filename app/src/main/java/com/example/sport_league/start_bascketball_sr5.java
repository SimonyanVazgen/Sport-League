...
public class start_bascketball_sr5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_bascketball_sr5);
        ...
        int[] buttonIds = new int[]{
                R.id.button12bsr5, R.id.button13bsr5, R.id.button14bsr5, R.id.button15bsr5,
                R.id.button16bsr5
        };
    ...
    private void setupButtonClickListener(int buttonId) {
        ...
        button.setOnClickListener(v -> {
            Intent intent = new Intent(start_bascketball_sr5.this, start_basketball_my_cards.class);
    ...
    private void updateButtonImageSetState(int buttonId, boolean state) {
        int index = -1;
        if (buttonId == R.id.button12bsr5) {
            index = 0;
        } else if (buttonId == R.id.button13bsr5) {
            index = 1;
        } else if (buttonId == R.id.button14bsr5) {
            index = 2;
        } else if (buttonId == R.id.button15bsr5) {
            index = 3;
        } else if (buttonId == R.id.button16bsr5) {
            index = 4;
        }
    ...
    private void checkNextButtonState() {
        Button nextButton = findViewById(R.id.next_bs5);
        boolean allSet = true;
        ...
        if (allSet) {
            nextButton.setOnClickListener(v -> {
                Intent intent = new Intent(start_bascketball_sr5.this, basketball_next.class);
