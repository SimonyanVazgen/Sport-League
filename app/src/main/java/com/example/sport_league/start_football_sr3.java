...
public class start_football_sr3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_football_sr3);
        ...
        int[] buttonIds = new int[]{
                R.id.buttonsr3, R.id.button2sr3, R.id.button3sr3, R.id.button4sr3,
                R.id.button5sr3, R.id.button6sr3, R.id.button7sr3, R.id.button8sr3,
                R.id.button9sr3, R.id.button10sr3, R.id.button11sr3
        };
    ...
    private void setupButtonClickListener(int buttonId) {
        ...
        button.setOnClickListener(v -> {
            Intent intent = new Intent(start_football_sr3.this, My_cards.class);
    ...
    private void updateButtonImageSetState(int buttonId, boolean state) {
        int index = -1;
        if (buttonId == R.id.buttonsr3) {
            index = 0;
        } else if (buttonId == R.id.button2sr3) {
            index = 1;
        } else if (buttonId == R.id.button3sr3) {
            index = 2;
        } else if (buttonId == R.id.button4sr3) {
            index = 3;
        } else if (buttonId == R.id.button5sr3) {
            index = 4;
        } else if (buttonId == R.id.button6sr3) {
            index = 5;
        } else if (buttonId == R.id.button7sr3) {
            index = 6;
        } else if (buttonId == R.id.button8sr3) {
            index = 7;
        } else if (buttonId == R.id.button9sr3) {
            index = 8;
        } else if (buttonId == R.id.button10sr3) {
            index = 9;
        } else if (buttonId == R.id.button11sr3) {
            index = 10;
        }
    ...
    private void checkNextButtonState() {
        Button nextButton = findViewById(R.id.next_ft3);
        boolean allSet = true;
        ...
        if (allSet) {
            nextButton.setOnClickListener(v -> {
                Intent intent = new Intent(start_football_sr3.this, football_next.class);
