...
public class start_football_sr3 extends AppCompatActivity {
    ...
    static final int IMAGE_SELECTION_REQUEST = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] buttonIds = {
                R.id.buttonsr3, R.id.button2sr3, R.id.button3sr3, R.id.button4sr3,
                R.id.button5sr3, R.id.button6sr3, R.id.button7sr3, R.id.button8sr3,
                R.id.button9sr3, R.id.button10sr3, R.id.button11sr3 // Keep only the first 11 IDs
        };
        ...
        for (int i = 0; i < buttonIds.length; i++) {
           ...
           buttons[i].setOnClickListener(v -> {
                if (!this.selectionsLocked) {
                    this.selectedButtonId = v.getId(); // Store the ID of the clicked button
                    selectCard();
                }
            });
        }
