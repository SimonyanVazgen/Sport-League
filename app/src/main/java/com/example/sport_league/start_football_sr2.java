...
public class start_football_sr2 extends AppCompatActivity {
    ...
    private void setupButtonClickListener(int buttonId) {
        ...
        button.setOnClickListener(v -> {
            Intent intent = new Intent(start_football_sr2.this, My_cards.class);
    ...
    private void updateButtonImageSetState(int buttonId, boolean state) {
        int index = -1;
        if (buttonId == R.id.buttonsr2) {
            index = 0;
        } else if (buttonId == R.id.button2sr2) {
            index = 1;
        } else if (buttonId == R.id.button2sr2) {
            index = 2;
        } else if (buttonId == R.id.button4sr2) {
            index = 3;
        } else if (buttonId == R.id.button5sr2) {
            index = 4;
        } else if (buttonId == R.id.button6sr2) {
            index = 5;
        } else if (buttonId == R.id.button7sr2) {
            index = 6;
        } else if (buttonId == R.id.button8sr2) {
            index = 7;
        } else if (buttonId == R.id.button9sr2) {
            index = 8;
        } else if (buttonId == R.id.button10sr2) {
            index = 9;
        } else if (buttonId == R.id.button11sr2) {
            index = 10;
        }
    ...
    private void checkNextButtonState() {
        Button nextButton = findViewById(R.id.next_ft2);
        boolean allSet = true;
        ...
        if (allSet) {
            nextButton.setOnClickListener(v -> {
                Intent intent = new Intent(start_football_sr2.this, football_next.class);
