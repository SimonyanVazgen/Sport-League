...
public class start_box extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (viewTeamButton != null) {
            viewTeamButton.setOnClickListener(v -> {
                Intent intent = new Intent(start_box.this, TeamDisplayActivity2.class);
                startActivityForResult(intent, TEAM_DISPLAY_REQUEST_CODE);
            });
        }

        int[] buttonIds = {
                R.id.button16, R.id.button12, R.id.button3
        };
    ...
    private void selectCard() {
        if (cardsSelected < 3) {
            Intent intent = new Intent(this, box_cards.class);
