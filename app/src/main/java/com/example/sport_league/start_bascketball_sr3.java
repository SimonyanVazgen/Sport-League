...
public class start_bascketball_sr3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_bascketball_sr3);
        ...
        int[] buttonIds = new int[]{
                R.id.button12bsr3, R.id.button13bsr3, R.id.button14bsr3, R.id.button15bsr3,
                R.id.button16bsr3
        };
    ...
    private void setupButtonClickListener(int buttonId) {
        ...
        button.setOnClickListener(v -> {
            Intent intent = new Intent(start_bascketball_sr3.this, start_basketball_my_cards.class);
    ...
    private void updateButtonImageSetState(int buttonId, boolean state) {
        int index = -1;
        if (buttonId == R.id.button12bsr3) {
            index = 0;
        } else if (buttonId == R.id.button13bsr3) {
            index = 1;
        } else if (buttonId == R.id.button14bsr3) {
            index = 2;
        } else if (buttonId == R.id.button15bsr3) {
            index = 3;
        } else if (buttonId == R.id.button16bsr3) {
            index = 4;
        }
    ...
    private void checkNextButtonState() {
        Button nextButton = findViewById(R.id.next_bs3);
        boolean allSet = true;
        ...
        if (allSet) {
            nextButton.setOnClickListener(v -> {
                Intent intent = new Intent(start_bascketball_sr3.this, basketball_next.class);
