...
public class start_football_sr7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_football_sr7);
        ...
        int[] buttonIds = new int[]{
                R.id.buttonsr7, R.id.button2sr7, R.id.button3sr7, R.id.button4sr7,
                R.id.button5sr7, R.id.button6sr7, R.id.button7sr7, R.id.button8sr7,
                R.id.button9sr7, R.id.button10sr7, R.id.button11sr7
        };
    ...
    private void setupButtonClickListener(int buttonId) {
        ...
        button.setOnClickListener(v -> {
            Intent intent = new Intent(start_football_sr7.this, My_cards.class);
    ...
    private void updateButtonImageSetState(int buttonId, boolean state) {
        int index = -1;
        if (buttonId == R.id.buttonsr7) {
            index = 0;
        } else if (buttonId == R.id.button2sr7) {
            index = 1;
        } else if (buttonId == R.id.button3sr7) {
            index = 2;
        } else if (buttonId == R.id.button4sr7) {
            index = 3;
        } else if (buttonId == R.id.button5sr7) {
            index = 4;
        } else if (buttonId == R.id.button6sr7) {
            index = 5;
        } else if (buttonId == R.id.button7sr7) {
            index = 6;
        } else if (buttonId == R.id.button8sr7) {
            index = 7;
        } else if (buttonId == R.id.button9sr7) {
            index = 8;
        } else if (buttonId == R.id.button10sr7) {
            index = 9;
        } else if (buttonId == R.id.button11sr7) {
            index = 10;
        }
    ...
    private void checkNextButtonState() {
        Button nextButton = findViewById(R.id.next_ft7);
        boolean allSet = true;
        ...
        if (allSet) {
            nextButton.setOnClickListener(v -> {
                Intent intent = new Intent(start_football_sr7.this, football_next.class);
