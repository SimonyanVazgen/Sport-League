...
public class start_football_sr5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_football_sr5);
        ...
        int[] buttonIds = new int[]{
                R.id.buttonsr5, R.id.button2sr5, R.id.button3sr5, R.id.button4sr5,
                R.id.button5sr5, R.id.button6sr5, R.id.button7sr5, R.id.button8sr5,
                R.id.button9sr5, R.id.button10sr5, R.id.button11sr5
        };
    ...
    private void setupButtonClickListener(int buttonId) {
        ...
        button.setOnClickListener(v -> {
            Intent intent = new Intent(start_football_sr5.this, My_cards.class);
    ...
    private void updateButtonImageSetState(int buttonId, boolean state) {
        int index = -1;
        if (buttonId == R.id.buttonsr5) {
            index = 0;
        } else if (buttonId == R.id.button2sr5) {
            index = 1;
        } else if (buttonId == R.id.button3sr5) {
            index = 2;
        } else if (buttonId == R.id.button4sr5) {
            index = 3;
        } else if (buttonId == R.id.button5sr5) {
            index = 4;
        } else if (buttonId == R.id.button6sr5) {
            index = 5;
        } else if (buttonId == R.id.button7sr5) {
            index = 6;
        } else if (buttonId == R.id.button8sr5) {
            index = 7;
        } else if (buttonId == R.id.button9sr5) {
            index = 8;
        } else if (buttonId == R.id.button10sr5) {
            index = 9;
        } else if (buttonId == R.id.button11sr5) {
            index = 10;
        }
    ...
    private void checkNextButtonState() {
        Button nextButton = findViewById(R.id.next_ft5);
        boolean allSet = true;
        ...
        if (allSet) {
            nextButton.setOnClickListener(v -> {
                Intent intent = new Intent(start_football_sr5.this, football_next.class);
